...
func setInstructions(in []byte, instructions []tokens, index int) (parsing_error error) {
...
func part1(instructions []tokens) int {
	for index, ins := range instructions {
		fmt.Println(index, ins.value)
	}
	return 0
}
